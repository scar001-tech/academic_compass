/**
 * MySQL REST sync layer for mark entries and timetable slots.
...
/**
 * Push a mark entry using optimistic version lock.
...
/** Push a timetable slot upsert with optimistic locking. */
