              ...
              <tr key={ex.id}>
                ...
                <td>
                  <select className="inline-edit" value={ex.term}
                    onChange={(e) => update(s => { const x = s.exams.find(x => x.id === ex.id); if (x) x.term = Number(e.target.value) as any; })}>
                ...
                <td>
                  <select className="inline-edit" value={ex.status}
                    onChange={(e) => update(s => { const x = s.exams.find(x => x.id === ex.id); if (x) x.status = e.target.value as any; })}>
