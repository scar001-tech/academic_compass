  ...
  const addStudent = () => {
    ...
    update((s) => {
      ...
      s.students.push({
        ...
        name: "New Student", gender: "M", classId: cls.id, streamId: stream.id,
        vap: "",
      });
    });
    ...
    <div>
      ...
      <Card className="overflow-x-auto">
        <table className="data-table">
          <thead>
            <tr>
              <th>Adm. No.</th><th>Name</th><th>Gender</th><th>Class</th><th>Stream</th><th>VAP</th>{canManageStudents && <th></th>}
            </tr>
          </thead>
          <tbody>
            {students.map((s) => {
